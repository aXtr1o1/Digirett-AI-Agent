...
def get_collection_schema(vector_dim: int = DEFAULT_VECTOR_DIM) -> CollectionSchema:
    """Returns the canonical CollectionSchema for digirett legal chunks."""
    fields = [
        ...
        FieldSchema(name="embedding", dtype=DataType.FLOAT_VECTOR, dim=vector_dim, description="Vector embedding"),
        FieldSchema(name="text", dtype=DataType.VARCHAR, max_length=65535, description="Embedding chunk text"),
