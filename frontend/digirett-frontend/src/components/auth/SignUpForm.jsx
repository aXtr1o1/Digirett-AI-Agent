        ...
        {!needsVerification ? (
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#1a1a1a] border border-gray-800 text-white font-medium py-3 rounded-xl flex items-center justify-center gap-3 hover:bg-[#252525] transition-all"
            >
