  ...
  return (
    <div className={`flex gap-4 mb-6 ${isUser ? "justify-end" : "justify-start"}`}>
      ...
      <div className={`flex flex-col min-w-0 ${isUser ? "items-end max-w-[85%]" : "flex-1"}`}>
        ...
        {/* USER: bubble style. ASSISTANT: plain text, ChatGPT-style */}
        {isUser ? (
          ...
          <div className={`text-sm leading-7 break-words w-full ${
            ...
            <ReactMarkdown
              ...
              components={{
                ...
                code({ inline, children }) {
                  ...
                  return (
                    <pre className={`rounded-xl p-4 my-3 overflow-x-auto text-xs font-mono ${
                ...
                hr: () => <hr className={`my-4 ${isDark ? "border-gray-700" : "border-gray-200"}`} />,
              }}
            >
              {message.content}
            </ReactMarkdown>
